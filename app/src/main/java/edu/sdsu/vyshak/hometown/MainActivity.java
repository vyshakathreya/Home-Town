...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener { //, SearchFragment.OnHeadlineSelectedListener

    FormFragment fragmentForm = new FormFragment();
    SearchFragment fragmentSearch = new SearchFragment();
    ResultListFragment fragmentResultList = new ResultListFragment();
    ...
    private void loadFormFragment() {
        FragmentManager fragments = getSupportFragmentManager();
        FragmentTransaction fragmentTransaction = fragments.beginTransaction();
        fragmentTransaction.replace(R.id.content_frame, fragmentForm);
        fragmentTransaction.commit();
    }
}
